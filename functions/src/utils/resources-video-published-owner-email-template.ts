  ...
  const html = wrapSmartRefillLetterHtml({
    ...
    bodyHtml: `
      ...
      <div style="margin:0;padding:16px;border-radius:6px;background:#f4f5f7;border:1px solid #dfe1e6;">
        <p style="margin:0;font-size:15px;font-weight:700;color:#172b4d;">${escapeHtmlForEmail(videoName)}</p>
        <p style="margin:8px 0 0;font-size:13px;line-height:1.45;color:#5e6c84;">Open Resources to watch it on your station dashboard.</p>
      </div>
    `,
